...
class IrrigationBot:
    ...
    def __init__(self, broker, port, topic):
        ...
        self.tokenBot = "5926302681:AAFdFOvN3JduepIvikaw9Njnj6JJWwmsBQs"
        # Catalog token
...
#        self.client = MyMQTT("telegramBot", broker, port, self)
    ...
    def send_message(self, msg, user, farm, section):
        ...
        for chat_ID in chat_IDs:
            self.bot.sendMessage(chat_ID, text=f'The {username}\'s has sent a message')
            

    def on_chat_message(self, msg):
        # content_type, chat_type ,chat_ID = telepot.glance(msg)
        # message=msg['text']
        self.bot.sendMessage(text="Welcome. The Contact already registered,"
...
if __name__=="__main__":
    ...
    topics = (requests.get('http://127.0.0.1:8080/catalog/all_topics?type=infraction').json())["value"]
